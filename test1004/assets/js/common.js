...
$(window).load(function() {
    $('.price_box').each(function(i, box) {
        var maxHeight = 0;
        $(box).find('.price_li').each(function() {
            if ($(this).height() > maxHeight) maxHeight = $(this).height();
        });
        $(box).find('.price_li').height(maxHeight);
    });
});

$(function () {      
//SP_FOOTERMENU
$("#section__service .content-inner ul li dl dt").click(function(){
